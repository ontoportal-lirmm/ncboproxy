...
- [ncboproxy](#ncboproxy)
  * [I. General architecture](#general-architecture)
    + [I.1. Servlet handlers](#servlet-handlers)
    + [I.2. Parameter handlers](#parameter-handlers)
    + [I.3 Post-processors](#post-processors)
    + [I.4. OutputGenerators](#outputgenerators)
    + [I.5. NCBOOutputModel](#ncbooutputmodel)
    + [I.6. NCBOProxyServlet](#ncboproxyservlet)
    + [I.7. Graphical summary](#graphical-summary)
  * [II. OMTDShare Adapter](#omtdshare-adapter)
...
### III.1. Building the war file and configuring the proxy
